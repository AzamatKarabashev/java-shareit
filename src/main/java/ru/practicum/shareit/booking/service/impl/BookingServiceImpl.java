...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public List<BookingResponseDto> getBookingByBookerId(Long bookerId, String state, Integer from, Integer size) {
    ...
    @Override
    public List<BookingResponseDto> getBookingByOwnerId(Long ownerId, String state, Integer from, Integer size) {
